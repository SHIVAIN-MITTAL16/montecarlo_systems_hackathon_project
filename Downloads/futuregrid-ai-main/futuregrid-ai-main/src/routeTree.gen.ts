...
// SIH alignment adds no new route; /digital-twin is now the Polar Station deployment.
...
const Texas2021Route = Texas2021RouteImport.update({ id: '/texas-2021', path: '/texas-2021', getParentRoute: () => rootRouteImport } as any)
...
const DigitalTwinRoute = DigitalTwinRouteImport.update({ id: '/digital-twin', path: '/digital-twin', getParentRoute: () => rootRouteImport } as any)
const ControlRoomRoute = ControlRoomRouteImport.update({ id: '/control-room', path: '/control-room', getParentRoute: () => rootRouteImport } as any)
...
export interface FileRouteTypes {
  ...
  fullPaths: '/' | '/control-room' | '/digital-twin' | '/simulation' | '/sitemap.xml' | '/texas-2021'
  fileRoutesByTo: FileRoutesByTo
  to: '/' | '/control-room' | '/digital-twin' | '/simulation' | '/sitemap.xml' | '/texas-2021'
  id: '__root__' | '/' | '/control-room' | '/digital-twin' | '/simulation' | '/sitemap.xml' | '/texas-2021'
...
const rootRouteChildren: RootRouteChildren = { IndexRoute, ControlRoomRoute, DigitalTwinRoute, SimulationRoute, SitemapDotxmlRoute, Texas2021Route }
